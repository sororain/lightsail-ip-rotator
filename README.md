...
2. 对每个实例的 IP 进行持续 Ping 检测（30 秒内，有任一回复即视为可达）
...
| `PING_TIMEOUT` | 否 | `30` | Ping 检测时长（秒），持续发包，全丢才算不通 |
...
[2026/6/3 12:00:01] [INFO] 正在持续 Ping 1.2.3.4（最长 30 秒）
[2026/6/3 12:00:02] [INFO] 1.2.3.4 Ping 通，跳过本轮检测
[2026/6/3 12:02:30] [WARN] 5.6.7.8 持续 30 秒 Ping 无回复，判定为不通
